 ...
 */
public final class ClockProPPPPolicy implements KeyOnlyPolicy {
  ...
  public ClockProPPPPolicy(Config config) {
    ...
    this.policyStats = new PolicyStats("irr.ClockProPPP");
  ...
  public static Set<Policy> policies(Config config) {
    return ImmutableSet.of(new ClockProPPPPolicy(config));
  }
